...
int8_t lsm303agr_mag_read_data(struct lsm303agr_mag_data *mag_data, struct lsm303agr_dev *dev)
{
    ...
    mag_data->x = (int16_t)( ((uint16_t)data[1] << 8) | (uint16_t)data[0] );
    mag_data->y = (int16_t)( ((uint16_t)data[3] << 8) | (uint16_t)data[2] );
    mag_data->z = (int16_t)( ((uint16_t)data[5] << 8) | (uint16_t)data[4] );
